...
<?php if ($previous_page !== FALSE): ?>
    <li><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev" class="prev"><</a></li>
<?php else: ?>
    <li><a rel="prev" class="prev" style="opacity: .3"><</a></li>
<?php endif ?>

<?php foreach ($links as $number => $content): ?>
    <?php if ($number === $current_page): ?>
        <li><a class="active"><?php echo $content ?></a></li>
    <?php else: ?>
...
<?php if ($next_page !== FALSE): ?>
    <li><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next" class="next">></a></li>
<?php else: ?>
    <li><a rel="next" class="next" style="opacity: .3">></a></li>
        <?php endif ?>